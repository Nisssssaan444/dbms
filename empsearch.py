...
def search():
    ...
    if option == "Name":
        ...
        mycursor.execute("SELECT * FROM employee_table WHERE id = %s", (search_input,))
    else:
        return
...
def draw_result():
    ...
    result_dept = Label(result, text="", font=("Minion Pro Regular", 20), bd=0, bg="#777", fg="#fff")
    ...
    result_desg = Label(result, text="", font=("Minion Pro Regular", 20), bd=0, bg="#777", fg="#fff")
