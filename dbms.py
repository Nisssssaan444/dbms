...
def execute_query():
    ...
    try:
        ...
        messagebox.showerror("Alert", f"An error occurred: {e}")
        db.rollback()
        db.close()
        return
...
# Heading label
pul= Label(header, text=" IOE PULCHOWK CAMPUS", font=("Helvetica", 28, "bold"), bg="brown", fg="#eae2b7")
pul.place(x=0, y=10, width=900)
# Profile frame
